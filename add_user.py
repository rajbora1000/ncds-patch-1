...
def save_user():
    if True:
        ...
        tkinter.messagebox.showinfo('No Deletion Message','I.D. not Deleted')
...
first_name=Entry(t,font=tkFont.Font(family="Times New Roman", size=20), borderwidth=2, relief="solid").place(x=200, y=10)
...
add_user_button=Button(t, text='Save User', command=save_user,borderwidth=2, relief="solid", width=26,height=2).place(x=216, y=620)
mainloop()